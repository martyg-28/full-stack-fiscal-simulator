...
*Step 1. Sticky stepper at the top, "Policy Palette" hero with the live sustainability score, role HUD + political-capital meter below.*
...
![Step 3 — Build your package](docs/step-3-build.png)
*Step 3. CBO budget options and policy sliders. The 10-year deficit impact pill updates in real time as you toggle reforms.*

![Step 4 — Stress-test the world](docs/step-4-world.png)
*Step 4. Four cartographic plates — flat transmission map, rotating globe, U.S. domestic atlas, and historical reference chart.*

![Step 5 — Read your results](docs/step-5-read.png)
*Step 5. Dossier figures with qualitative bands, tradeoff radar, scenario story, and charts.*

![Step 6 — Defend and save](docs/step-6-defend.png)
*Step 6. Historical precedent timeline, save-scenario panel, and the "Done · take the quiz" capstone button.*
