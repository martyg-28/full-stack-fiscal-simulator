// Exploratory fiscal model. This is intentionally simple: a clear set of
// formulas that lets a user see how policy levers and global stress assumptions
// compound into a long-run debt path. Not an official forecast.

export const baseline = {
  startYear: 2026,
  endYear: 2056,
  gdp2026: 32.0, // trillions of nominal USD, rough 2026 placeholder
  debtToGdp2026: 101,
...
// Spherical projection used by the globe component.
...
function fiscalPolicyEffect(policy, stress, year) {
  ...
  // Polarization and PAC pressure haircut: even good policy doesn't fully pass.
...
// Blend live government metrics into the user's manual stress dials.
